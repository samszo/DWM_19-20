L.Control.BoxZoom = L.Control.extend({
    ...
    onRemove: function(o) { this.options.aspectRatio && (delete this.map.boxZoom.aspectRatio, this.map.boxZoom._onMouseMove = L.Map.BoxZoom.prototype._onMouseMove, this.map.boxZoom._onMouseUp = L.Map.BoxZoom.prototype._onMouseUp) },
    toggleState: function() { this.active ? this.setStateOff() : this.setStateOn() },
    setStateOn: function() { L.DomUtil.addClass(this.controlDiv, "leaflet-control-boxzoom-active"), this.active = !0, this.map.dragging.disable(), this.options.enableShiftDrag || this.map.boxZoom.addHooks(), this.map.on("mousedown", this.handleMouseDown, this), this.options.keepOn || this.map.on("boxzoomend", this.setStateOff, this), L.DomUtil.addClass(this.map._container, "leaflet-control-boxzoom-active") },
    ...
    handleMouseDown: function(o) { this.map.boxZoom._onMouseDown.call(this.map.boxZoom, { clientX: o.originalEvent.clientX, clientY: o.originalEvent.clientY, which: 1, shiftKey: !0 }) },
...
}), L.Control.boxzoom = function(o) { return new L.Control.BoxZoom(o) };